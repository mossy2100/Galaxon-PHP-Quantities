...
For the complete list of illuminance units, see [Supported Units: Illuminance](2.6_SupportedUnits.md#illuminance).
...
- **[Supported Units: Illuminance](2.6_SupportedUnits.md#illuminance)** - Complete list
