...
namespace OceanMoon\Quantities\Tests\NonCurrencies;
...
final class PhysicalConstantTest extends TestCase
{
    ...
    public function testSpeedOfLight(): void
    {
        ...
        $this->assertSame('m/s', $c->compoundUnit->asciiSymbol);
    }
    ...
    public function testPlanckConstant(): void
    {
        ...
        $this->assertSame('J*s', $h->compoundUnit->asciiSymbol);
    }
    ...
    public function testElementaryCharge(): void
    {
        ...
        $this->assertSame('C', $e->compoundUnit->asciiSymbol);
    }
    ...
    public function testBoltzmannConstant(): void
    {
        ...
        $this->assertSame('J/K', $k->compoundUnit->asciiSymbol);
    }
    ...
    public function testAvogadroConstant(): void
    {
        ...
        $this->assertSame('mol-1', $na->compoundUnit->asciiSymbol);
    }
    ...
    public function testCaesiumFrequency(): void
    {
        ...
        $this->assertSame('Hz', $deltaNuCs->compoundUnit->asciiSymbol);
    }
    ...
    public function testLuminousEfficacy(): void
    {
        ...
        $this->assertSame('lm/W', $kcd->compoundUnit->asciiSymbol);
    }
    ...
    public function testStandardGravity(): void
    {
        ...
        $this->assertSame('m/s2', $g->compoundUnit->asciiSymbol);
    }
    ...
    public function testVacuumPermittivity(): void
    {
        ...
        $this->assertSame('F/m', $epsilon0->compoundUnit->asciiSymbol);
    }
    ...
    public function testElectronMass(): void
    {
        ...
        $this->assertSame('kg', $me->compoundUnit->asciiSymbol);
    }
    ...
    public function testProtonMass(): void
    {
        ...
        $this->assertSame('kg', $mp->compoundUnit->asciiSymbol);
    }
    ...
    public function testNeutronMass(): void
    {
        ...
        $this->assertSame('kg', $mn->compoundUnit->asciiSymbol);
    }
    ...
    public function testFineStructureConstant(): void
    {
        ...
        $this->assertSame('', $alpha->compoundUnit->asciiSymbol);
    }
    ...
    public function testRydbergConstant(): void
    {
        ...
        $this->assertSame('m-1', $rinf->compoundUnit->asciiSymbol);
    }
    ...
    public function testMolarGasConstant(): void
    {
        ...
        $this->assertSame('J/(mol*K)', $gasConst->compoundUnit->asciiSymbol);
    }
