...
For the complete list of catalytic activity units, see [Supported Units: Catalytic Activity](2.6.%20Supported%20Units.md#catalytic-activity).
...
- **[Supported Units: Catalytic Activity](2.6.%20Supported%20Units.md#catalytic-activity)** - Complete list
