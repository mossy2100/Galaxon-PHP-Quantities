...
For the complete list of area units, see [Supported Units: Area](../../DeveloperGuide/SupportedUnits.md#area).
...
- **[Supported Units: Area](../../DeveloperGuide/SupportedUnits.md#area)** - Complete list of area units
