...
final class QuantityArithmeticTest extends TestCase
{
    ...
    public function testAddSameUnits(): void
    {
        ...
        $this->assertSame('m', $sum->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddWithConversion(): void
    {
        ...
        $this->assertSame('mi', $sum->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddPreservesFirstUnit(): void
    {
        ...
        $this->assertSame('km', $sum->compoundUnit->asciiSymbol);
    }
    ...
    public function testSubDifferentUnits(): void
    {
        ...
        $this->assertSame('km', $diff->compoundUnit->asciiSymbol);
    }
    ...
    public function testSubWithConversion(): void
    {
        ...
        $this->assertSame('mi', $diff->compoundUnit->asciiSymbol);
    }
    ...
    public function testMulByScalar(): void
    {
        ...
        $this->assertSame('m', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testMulByQuantity(): void
    {
        ...
        $this->assertSame('m2', $area->compoundUnit->asciiSymbol);
    }
    ...
    public function testMulDifferentTypes(): void
    {
        ...
        $this->assertSame('N*m', $energy->compoundUnit->asciiSymbol);
    }
    ...
    public function testDivByQuantity(): void
    {
        ...
        $this->assertSame('m/s', $velocity->compoundUnit->asciiSymbol);
    }
    ...
    public function testDivBySameUnitCancels(): void
    {
        ...
        $this->assertTrue($ratio->compoundUnit->isDimensionless());
    }
    ...
    public function testInv(): void
    {
        ...
        $this->assertSame('s-1', $frequency->compoundUnit->asciiSymbol);
    }
    ...
    public function testPowPositive(): void
    {
        ...
        $this->assertSame('m3', $volume->compoundUnit->asciiSymbol);
    }
    ...
    public function testPowOne(): void
    {
        ...
        $this->assertSame(5.0, $result->value);
        $this->assertSame('km', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testPowNegative(): void
    {
        ...
        $this->assertSame(0.25, $result->value);
        $this->assertSame('m-2', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testPowWithPrefixedUnit(): void
    {
        ...
        $this->assertSame('km2', $area->compoundUnit->asciiSymbol);
    }
    ...
    public function testPowWithCompoundUnit(): void
    {
        ...
        $this->assertSame('m2/s2', $result->compoundUnit->asciiSymbol);
    }
