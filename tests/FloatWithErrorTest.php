...
class FloatWithErrorTest extends TestCase
{
    ...
    /**
     * Test significantDigits with exact value.
     */
    public function testSignificantDigitsExactValue(): void
    {
        $num = new FloatWithError(42.0, 0.0);

        $this->assertSame(PHP_INT_MAX, $num->significantDigits());
    }

    /**
     * Test significantDigits with 1% relative error.
     */
    public function testSignificantDigitsOnePercent(): void
    {
        $num = new FloatWithError(100.0, 1.0); // Absolute error 1.0 gives 1% relative error

        // -log10(0.01) = 2
        $this->assertSame(2, $num->significantDigits());
    }

    /**
     * Test significantDigits with 0.1% relative error.
     */
    public function testSignificantDigitsPointOnePercent(): void
    {
        $num = new FloatWithError(1000.0, 1.0); // Absolute error 1.0 gives 0.1% relative error

        // -log10(0.001) = 3
        $this->assertSame(3, $num->significantDigits());
    }

    /**
     * Test significantDigits with infinite error.
     */
    public function testSignificantDigitsInfiniteError(): void
    {
        $num = new FloatWithError(10.0, INF);

        $this->assertSame(0, $num->significantDigits());
    }

    /**
     * Test significantDigits with zero value.
     */
    public function testSignificantDigitsZeroValue(): void
    {
        $num = new FloatWithError(0.0, 1.0);
    ...
    public function testToStringFormat(): void
    {
        ...
        $this->assertStringContainsString('sig. digits', $str);
    }
    ...
    public function testToStringExactValue(): void
    {
        ...
        $this->assertStringContainsString(sprintf('%d sig. digits', PHP_INT_MAX), $str);
    }
