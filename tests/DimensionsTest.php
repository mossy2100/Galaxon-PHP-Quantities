...
final class DimensionsTest extends TestCase
{
    ...
    {
        $this->assertFalse(Dimensions::isValid(''));
    }
    ...
    public function testExplodeSingleCodeWithExponent(): void
    {
        $this->assertSame([
            'L' => 2,
        ], Dimensions::explode('L2'));
        $this->assertSame([
            'L' => 3,
        ], Dimensions::explode('L3'));
        $this->assertSame([
            'T' => -1,
        ], Dimensions::explode('T-1'));
        $this->assertSame([
            'T' => -2,
        ], Dimensions::explode('T-2'));
    }
    ...
    {
        $result = Dimensions::explode('MLT-2');
    ...
    {
        $result = Dimensions::explode('ML2T-2');
    ...
    public function testExplodeThrowsForInvalidCode(): void
    {
        ...
        Dimensions::explode('XYZ');
    }

    /**
     * Test explode() throws DomainException for empty string.
     */
    public function testExplodeThrowsForEmptyString(): void
    {
        $this->expectException(DomainException::class);
    ...
    {
        $this->assertSame('L2', Dimensions::implode([
            'L' => 2,
        ]));
        $this->assertSame('L3', Dimensions::implode([
            'L' => 3,
        ]));
        $this->assertSame('T-1', Dimensions::implode([
            'T' => -1,
        ]));
        $this->assertSame('T-2', Dimensions::implode([
            'T' => -2,
        ]));
    }
    ...
    public function testExplodeImplodeRoundTrip(): void
    {
        ...
        foreach ($codes as $code) {
            ...
            $exploded = Dimensions::explode($normalized);
            $imploded = Dimensions::implode($exploded);
