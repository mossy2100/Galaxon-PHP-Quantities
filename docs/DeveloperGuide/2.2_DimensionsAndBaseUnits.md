...
3. Troy ounces of gold (`XAU`) are used as the common base currency; any national currency would by definition not be international.

Furthermore, every dimension is also assigned a base English unit. The concept of "English" units here encompasses both imperial and US customary units.
