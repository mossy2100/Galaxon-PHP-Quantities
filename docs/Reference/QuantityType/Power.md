...
For the complete list of power units, see [Supported Units: Power](2.6_SupportedUnits.md#power).
...
- **[Supported Units: Power](2.6_SupportedUnits.md#power)** - Complete list
