...
final class EnergyTest extends TestCase
{
    ...
    {
        $units = Energy::getUnitDefinitions();
    ...
    {
        $conversions = Energy::getConversionDefinitions();
    ...
    public function testConvertJoulesToKilojoules(): void
    {
        ...
        $this->assertSame('kJ', $kj->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddJoulesToJoules(): void
    {
        ...
        $this->assertSame('J', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseJoules(): void
    {
        ...
        $this->assertSame('J', $energy->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseKilojoules(): void
    {
        ...
        $this->assertSame('kJ', $energy->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseKilocalories(): void
    {
        ...
        $this->assertSame('kcal', $energy->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseElectronvolts(): void
    {
        ...
        $this->assertSame('MeV', $energy->compoundUnit->asciiSymbol);
    }
