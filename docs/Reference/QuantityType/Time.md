...
For the complete list of time units, see [Supported Units: Time](2.6_SupportedUnits.md#time).
...
- **[Supported Units: Time](2.6_SupportedUnits.md#time)** - Complete list of time units
