...
For the complete list of conductance units, see [Supported Units: Conductance](2.6_SupportedUnits.md#conductance).
...
- **[Supported Units: Conductance](2.6_SupportedUnits.md#conductance)** - Complete list
