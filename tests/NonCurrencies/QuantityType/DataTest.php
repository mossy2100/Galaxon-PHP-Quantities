...
final class DataTest extends TestCase
{
    ...
    public function testConvertBytesToBits(): void
    {
        ...
        $this->assertSame('b', $bits->compoundUnit->asciiSymbol);
    }
    ...
    public function testConvertBitsToByte(): void
    {
        ...
        $this->assertSame('B', $bytes->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddBytesToKilobytes(): void
    {
        ...
        $this->assertSame('kB', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddMegabytesToGigabytes(): void
    {
        ...
        $this->assertSame(1.5, $result->value);
        $this->assertSame('GB', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseBytes(): void
    {
        ...
        $this->assertSame('B', $data->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseKilobytes(): void
    {
        ...
        $this->assertSame('kB', $data->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseGigabytes(): void
    {
        ...
        $this->assertSame('GB', $data->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseKibibytes(): void
    {
        ...
        $this->assertSame('KiB', $data->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseMebibytes(): void
    {
        ...
        $this->assertSame('MiB', $data->compoundUnit->asciiSymbol);
    }
    ...
    public function testNetworkSpeedConversion(): void
    {
        ...
        $this->assertSame('MB/s', $mbytesPerSec->compoundUnit->asciiSymbol);
    }
    ...
    public function testToSiThenAutoPrefixLargeBytes(): void
    {
        ...
        $this->assertSame('MB', $si->compoundUnit->asciiSymbol);
    }
    ...
    public function testAutoPrefixBytesToKilobytes(): void
    {
        ...
        $this->assertSame('kB', $prefixed->compoundUnit->asciiSymbol);
    }
    ...
    public function testAutoPrefixBytesToMegabytes(): void
    {
        ...
        $this->assertSame(5.0, $prefixed->value);
        $this->assertSame('MB', $prefixed->compoundUnit->asciiSymbol);
    }
    ...
    public function testAutoPrefixBytesToGigabytes(): void
    {
        ...
        $this->assertSame(5.0, $prefixed->value);
        $this->assertSame('GB', $prefixed->compoundUnit->asciiSymbol);
    }
    ...
    public function testAutoPrefixSmallBytesStaysBytes(): void
    {
        ...
        $this->assertSame(500.0, $prefixed->value);
        $this->assertSame('B', $prefixed->compoundUnit->asciiSymbol);
    }
    ...
    public function testAutoPrefixDataRate(): void
    {
        ...
        $this->assertSame('Mb/s', $prefixed->compoundUnit->asciiSymbol);
    }
