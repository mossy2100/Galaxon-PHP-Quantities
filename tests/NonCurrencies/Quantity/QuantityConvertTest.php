...
final class QuantityConvertTest extends TestCase
{
     ...
     */
    public function testConvertCompoundUnits(): void
    {
        // 1 m/s = 3.6 km/h
    ...
    /**
     * Test conversion accepts CompoundUnit objects.
     */
    public function testConvertAcceptsCompoundUnitObjects(): void
    {
        $srcUnit = CompoundUnit::parse('kg');
        $destUnit = CompoundUnit::parse('g');
