...
For the complete list of electric current units, see [Supported Units: Electric Current](2.6_SupportedUnits.md#electric-current).
...
- **[Supported Units: Electric Current](2.6_SupportedUnits.md#electric-current)** - Complete list
