...
For the complete list of time units, see [Supported Units: Time](2.6.%20Supported%20Units.md#time).
...
- **[Supported Units: Time](2.6.%20Supported%20Units.md#time)** - Complete list of time units
