...
For the complete list of frequency units, see [Supported Units: Frequency](2.6_SupportedUnits.md#frequency).
...
- **[Supported Units: Frequency](2.6_SupportedUnits.md#frequency)** - Complete list of frequency units
