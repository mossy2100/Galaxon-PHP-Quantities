...
| English base unit  | A base unit within the imperial and US customary systems of units: *lb*, *ft*, *s*, *°R* (degrees Rankine), or *°* (degrees of angle).                                                                                                            |
| Common base unit   | Additional base units for non-physical quantities: *B* (bytes) and *XAU* (troy ounces of gold).                                                                                                                                                   |
| SI named unit      | An SI unit named after a person, e.g. newton (*N*), joule (*J*), or watt (*W*).                                                                                                                                                                   |
...
| Compound unit      | A unit formed by combining zero or more unit terms via multiplication and/or division, e.g. *m/s*, *kg·m/s²*.                                                                                                                                     |
| Derived unit       | A unit that substitutes for a compound unit, e.g. *N* can be expanded to *kg·m/s²*. This includes all SI named units plus a few others like *lbf*, *cal*, *eV*, and *kn*. Also, any compound unit that includes an expandable, unit, e.g. *N/m2*. |
