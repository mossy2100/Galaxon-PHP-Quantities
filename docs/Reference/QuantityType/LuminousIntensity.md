...
For the complete list of luminous intensity units, see [Supported Units: Luminous Intensity](2.6_SupportedUnits.md#luminous-intensity).
...
- **[Supported Units: Luminous Intensity](2.6_SupportedUnits.md#luminous-intensity)** - Complete list
