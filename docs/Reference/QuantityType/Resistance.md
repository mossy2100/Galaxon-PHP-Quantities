...
For the complete list of resistance units, see [Supported Units: Resistance](2.6_SupportedUnits.md#resistance).
...
- **[Supported Units: Resistance](2.6_SupportedUnits.md#resistance)** - Complete list
