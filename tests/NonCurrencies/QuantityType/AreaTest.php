...
final class AreaTest extends TestCase
{
    ...
    public function testConvertSquareMetersToSquareKilometers(): void
    {
        ...
        $this->assertSame('km²', $km2->compoundUnit->unicodeSymbol);
    }
    ...
    public function testCreateWithUnicodeSuperscript(): void
    {
        ...
        $this->assertSame('m²', $area->compoundUnit->unicodeSymbol);
    }
    ...
    public function testParseHectares(): void
    {
        ...
        $this->assertSame('ha', $area->compoundUnit->asciiSymbol);
    }
    ...
    public function testMulKilometersByKilometers(): void
    {
        ...
        $this->assertSame('km²', $result->compoundUnit->unicodeSymbol);
    }
    ...
    public function testAddHectaresToHectares(): void
    {
        ...
        $this->assertSame('ha', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddAcresToAcres(): void
    {
        ...
        $this->assertSame('ac', $result->compoundUnit->asciiSymbol);
    }
