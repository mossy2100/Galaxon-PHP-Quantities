...
For the complete list of inductance units, see [Supported Units: Inductance](../../DeveloperGuide/SupportedUnits.md#inductance).
...
- **[Supported Units: Inductance](../../DeveloperGuide/SupportedUnits.md#inductance)** - Complete list
