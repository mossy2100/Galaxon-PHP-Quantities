...
For the complete list of luminous intensity units, see [Supported Units: Luminous Intensity](Units.md#luminous-intensity).
...
- **[Supported Units: Luminous Intensity](Units.md#luminous-intensity)** - Complete list
