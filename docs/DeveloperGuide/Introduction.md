...
- **String formatting** — Format quantities as either ASCII or Unicode, using locale-specific formats and decimal places.
...
Start with [Terminology](Terminology.md) if the concepts are new, or jump to [Creating Quantities](CreatingQuantities.md) if you want to dive straight in.
