...
final class PressureTest extends TestCase
{
    ...
    public function testConvertPascalsToKilopascals(): void
    {
        ...
        $this->assertSame('kPa', $kpa->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddPascalsToPascals(): void
    {
        ...
        $this->assertSame('Pa', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddAtmospheresToKilopascals(): void
    {
        ...
        $this->assertSame('kPa', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testAddMmHgToAtmospheres(): void
    {
        ...
        $this->assertSame('atm', $result->compoundUnit->asciiSymbol);
    }
    ...
    public function testParsePascals(): void
    {
        ...
        $this->assertSame('Pa', $pressure->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseKilopascals(): void
    {
        ...
        $this->assertSame('kPa', $pressure->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseAtmospheres(): void
    {
        ...
        $this->assertSame('atm', $pressure->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseMmHg(): void
    {
        ...
        $this->assertSame('mmHg', $pressure->compoundUnit->asciiSymbol);
    }
    ...
    public function testParseInHg(): void
    {
        ...
        $this->assertSame('inHg', $pressure->compoundUnit->asciiSymbol);
    }
