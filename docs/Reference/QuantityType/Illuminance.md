...
For the complete list of illuminance units, see [Supported Units: Illuminance](../../DeveloperGuide/2.6_SupportedUnits.md#illuminance).
...
- **[Supported Units: Illuminance](../../DeveloperGuide/2.6_SupportedUnits.md#illuminance)** - Complete list
