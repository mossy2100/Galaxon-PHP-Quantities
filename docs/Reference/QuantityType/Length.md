...
For the complete list of length units, see [Supported Units: Length](../../DeveloperGuide/2.6_SupportedUnits.md#length).
...
- **[Supported Units: Length](../../DeveloperGuide/2.6_SupportedUnits.md#length)** - Complete list of length units
