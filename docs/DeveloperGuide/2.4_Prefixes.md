...
| `GROUP_ENGINEERING` | 1 \| 4           | Engineering metric (powers of 1000). This includes all small and large metric prefixes, excluding the medium ones. |
| `GROUP_LARGE`       | 4 \| 8           | Large metric + binary (i.e. kilo and Kibi upwards).                                                                |
