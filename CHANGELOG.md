...
- **Renamed package** from `galaxon/quantities` to `oceanmoon/quantities` — update your `composer.json` require accordingly.
- **Renamed PHP namespaces** from `Galaxon\Quantities\*` to `OceanMoon\Quantities\*` throughout all source and test files.
