...
final class QuantityCreateTest extends TestCase
{
    ...
    public function testCreateTimeWithConstructor(): void
    {
        ...
        $this->assertSame('s', $time->compoundUnit->asciiSymbol);
    }
    ...
    public function testCreateWithMetricPrefixes(): void
    {
        ...
        $this->assertSame('mm', $mm->compoundUnit->asciiSymbol);

        $this->assertSame(500.0, $mg->value);
        $this->assertSame('mg', $mg->compoundUnit->asciiSymbol);
    ...
    public function testFromPartsReturnsAngleInstance(): void
    {
        ...
        $this->assertSame('deg', $qty->compoundUnit->asciiSymbol);
     ...
     */
    public function testDimensionPropertyReturnsCompoundUnitDimension(): void
    {
        $length = Quantity::create(5, 'm');
