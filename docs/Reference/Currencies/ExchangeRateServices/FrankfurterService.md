...
The ECB publishes rates for approximately 30 major currencies. This is the simplest service to use as it requires no authentication or configuration, but it covers fewer currencies than the paid
services.
